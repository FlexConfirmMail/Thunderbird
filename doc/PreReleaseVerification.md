...
11. 組織外の宛先の見出し部分のチェックボックスをオフにする。
    * [ ] 組織外の宛先全てのチェックが外れる。
    * [ ] 「送信」がグレイアウトしている。
12. 組織内の宛先の見出し部分のチェックボックスをオフにする。
    * [ ] 組織内の宛先全てのチェックが外れる。
    * [ ] 「送信」がグレイアウトしている。
13. 組織外の宛先の見出し部分のチェックボックスをオンにする。
    * [ ] 組織外の宛先全てにチェックが付く。
    * [ ] 「送信」がグレイアウトしている。
14. 組織内の宛先の見出し部分のチェックボックスをオンにする。
    * [ ] 組織内の宛先全てのチェックが外れる。
    * [ ] 「送信」が有効になる。
15. 「キャンセル」を押して確認のダイアログを閉じる。
16. メール編集ウィンドウをそのまま残し、FlexConfirmMailの設定画面を開く。
17. 「宛先」→「組織内の宛先の一括チェックを許可」のチェックを外す。
18. 「宛先」→「外部の宛先の一括チェックを許可」のチェックを外す。
19. メール編集ウィンドウに戻る。
20. 「送信」を押す。
    * [ ] チェックボックスがある確認画面が開かれる。
    * [ ] 「送信」がグレイアウトしている。
...
22. メール編集ウィンドウを閉じる
23. メール編集ウィンドウをそのまま残し、FlexConfirmMailの設定画面を開く。
24. 「宛先」→「組織内の宛先の一括チェックを許可」のチェックを入れる。
